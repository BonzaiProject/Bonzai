...
typedef struct {
    /*@reldef@*/ unsigned long state[5];
    /*@reldef@*/ unsigned long count[2];
    /*@reldef@*/ unsigned char buffer[64];
} SHA1_CTX;
...
void SHA1Init(SHA1_CTX* context)
{
    ...
    context->state[0] = (unsigned long int)0x67452301;
    context->state[1] = (unsigned long int)0xEFCDAB89;
    context->state[2] = (unsigned long int)0x98BADCFE;
    context->state[3] = (unsigned long int)0x10325476;
    context->state[4] = (unsigned long int)0xC3D2E1F0;
