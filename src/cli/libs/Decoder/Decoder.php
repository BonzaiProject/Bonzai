...
class PG_Decoder {
    ...
    public function elaborate($element) {
        ...
        // Decode the content
        $decoded_content = $this->pgCodeDecrypt($content);
    ...
    protected function pgCodeDecrypt($data) {
        ...
        // Decrypt the data
        $crdata = $this->pgCycleDecrypt($tmpdata, $key_len, $data_len);
    ...
    protected function pgCycleDecrypt($string, $key_len, $data_len) {
        ...
        for($i = 0, $j = 0; $i < $data_len; $i += 2, $j++) {
            ...
            $crdata  .= $this->decodeChar($enc_char, PG_Script_Parser::$config['KEY']['KEY_HASH'][$j % $key_len]);
        }
